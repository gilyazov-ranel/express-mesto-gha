...
const {
  validateUserJoi, validationUserId, validationUpdateUser, validationUpdateAvatarUser,
} = require('../utilit/validateUser');

router.get('/', validateUserJoi, getUsers);
router.get('/me', validateUserJoi, getCurrentUser);
